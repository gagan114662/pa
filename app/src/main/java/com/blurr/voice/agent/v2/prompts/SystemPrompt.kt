package com.blurr.voice.agent.v2.prompts

data class SystemMessage(val content: String)

class SystemPrompt(
    actionDescription: String,
    private val maxActionsPerStep: Int = 10,
    overrideSystemMessage: String? = null,
    extendSystemMessage: String? = null,
) {
    private val defaultActionDescription: String = actionDescription
...
""".trimIndent()
    ...
    fun getSystemMessage(): SystemMessage {
